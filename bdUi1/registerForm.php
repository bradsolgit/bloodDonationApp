  ...
  <p class="form-tile"><span class="glyphicon glyphicon-user"></span> Registration </p>
	...
	<div style="clear:both;"></div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div style="margin-top:10px;"><label class="radio-inline"><b> Gender:</b> </label><label
							class="radio-inline"> <input type="radio" name="gender" class="radio" value="M">Male
						</label> <label class="radio-inline"> <input type="radio" class="radio" name="gender" value="F">Female
						</label>
