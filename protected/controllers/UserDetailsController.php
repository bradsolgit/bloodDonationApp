		...
		if (isset ( $_POST ['UserDetails'] )) {
			...
			foreach ($objWorksheet->getRowIterator() as $key1 => $row) {
				...
				foreach ($cellIterator as $key => $cell) {
					...
					switch($key) { 
						case 0: $tempModel->name = $cell->getCalculatedValue();
								 break;
						case 1: $tempModel->number = $cell->getCalculatedValue(); 
								break; 
						case 2: $tempModel->city = Utilities::getLookupIdByValue(Constants::$city_lookup_code,$cell->getCalculatedValue()); 
								break; 
						case 3: $tempModel->gender = $cell->getCalculatedValue();
						break;
						case 4: $tempModel->donation_status = $cell->getCalculatedValue();
						break;
						case 5: $tempModel->dob = $cell->getCalculatedValue();
						break;
						case 6: $tempModel->blood_group = Utilities::getLookupIdByValue(Constants::$bloodgrp_lookup_code,$cell->getCalculatedValue());
						break;
						case 7: $tempModel->address = $cell->getCalculatedValue();
						break;
						default: break; 
					}
